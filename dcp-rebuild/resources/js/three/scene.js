...
export class Scene {
  ...
  bindEvents() {
    ...
    window.addEventListener('dcp:themechange', this.themeHandler, { passive: true });
  }
  ...
  destroy() {
    ...
    if (this.themeHandler) window.removeEventListener('dcp:themechange', this.themeHandler);
    if (this.renderer) {
